...
const MUSHROOM_SCENE = preload("res://scenes/power_ups/super_mushroom.tscn")
const FIRE_FLOWER_SCENE = preload("res://scenes/power_ups/fire_flower.tscn")
const START_SCENE = preload("res://scenes/power_ups/super_star.tscn")
const EXTRA_LIFE_SCENE = preload("res://scenes/power_ups/extra_life.tscn")
...
func spawn_coin_visual():
	var coin_scene = preload("res://scenes/props/jumping_coin.tscn")
